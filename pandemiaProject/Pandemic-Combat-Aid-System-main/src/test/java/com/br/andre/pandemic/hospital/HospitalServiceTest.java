...
import com.br.andre.pandemic.builders.HospitalBuilder;
import com.br.andre.pandemic.exception.ObjectNotFoundException;
...
public class HospitalServiceTest {
    ...
    void shouldSaveHospital() throws ParseException {
        this.hospitalService.save(HospitalBuilder.createHospital());
    ...
    void shouldReturnHospitalWithThisId() throws ParseException {
        when(this.hospitalRepository.findById(anyLong())).thenReturn(
                Optional.of(HospitalBuilder.createHospital()));
    ...
    void shouldFindAllHospitals() throws ParseException {
        when(this.hospitalService.findAll()).thenReturn(
                List.of(HospitalBuilder.createHospital(), HospitalBuilder.createHospital()));
    ...
    void shouldUpdateHospitalOccupation() throws ParseException {
        ...
        when(this.hospitalRepository.findById(1L)).thenReturn(Optional.of(HospitalBuilder.createHospital()));
